...
export const useProductStore = defineStore("productStore", {
  state: () => ({
    products: [
      ...
      { id: 4, name: "애플워치 9", desc: "건강 모니터링 기능 강화", price: 650000, image: "/applewatch.png", category: "스마트기기" },
      { id: 5, name: "아이패드 프로", desc: "M2 칩 탑재 아이패드", price: 1400000, image: "/ipadpro.png", category: "태블릿" },
      ...
      { id: 7, name: "데님 자켓 & 니트 비니", desc: "라이트 워싱 데님 자켓과 포레스트 그린 리브드 비니.", price: 59000, image: "/linda-xu-fUEP0djb1hA-unsplash.jpg", category: "의류" },
      { id: 8, name: "미니멀 백팩", desc: "심플한 디자인의 다크 톤 백팩.", price: 49000, image: "/sun-lingyan-_H0fjILH5Vw-unsplash.jpg", category: "액세서리" },
      { id: 9, name: "기본 검정 티셔츠", desc: "무지 크루넥 반팔 티셔츠.", price: 19900, image: "/istockphoto-2206793808-1024x1024.jpg", category: "의류" },
    ],
    filtered: [],
    loading: false,
  }),
