...
const DEMO_PRODUCTS = [
  ...
  ["애플워치 9", "건강 모니터링 기능 강화", 650000, 20, "디지털/가전", "/images/applewatch-main.png"],
  ["아이패드 프로", "M2 칩 탑재 아이패드", 1400000, 8, "디지털/가전", "/images/a485248b-561b-4ee0-82fa-83ef371c1a58.jpg"],
  ["뉴발란스 파스텔 스니커즈", "라벤더와 코랄 포인트의 캐주얼 스니커즈.", 13000, 30, "패션잡화", "/images/linda-xu-fUEP0djb1hA-unsplash.jpg"],
  ["데님 자켓 & 니트 비니", "라이트 워싱 데님 자켓과 포레스트 그린 리브드 비니.", 59000, 20, "의류", "/images/85cb680b-b6bd-48bd-8ce4-9be2ce7ed365.jpg"],
  ["미니멀 백팩", "심플한 디자인의 다크 톤 백팩.", 49000, 15, "악세서리", "/images/sun-lingyan-_H0fjILH5Vw-unsplash.jpg"],
  ["기본 검정 티셔츠", "무지 크루넥 반팔 티셔츠.", 19900, 100, "의류", "/images/black-tshirt-main.png"],
];
