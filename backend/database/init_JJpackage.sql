...
-- 비밀번호는 bcrypt 해시 (평문 저장 시 로그인 불가)
-- 관리자 로그인: admin@myshop.com / admin123!
INSERT INTO users (email, password, name, gender, role)
VALUES
('shgy0673@naver.com', 'dpdpfmv770@!', '김승태', 'male', 'user'),
...
-- 상품 6컬럼: name, description, price, stock, category, image_url (CREATE TABLE와 개수 일치)
