...
VALUES
('아이폰 15', '최신 아이폰 모델', 1500000, '/images/iphone15.jpg'),
('맥북 프로', 'Apple M2 Pro 칩셋 탑재', 2800000, '/images/macbookpro.jpg'),
('에어팟 프로', '노이즈 캔슬링 무선 이어폰', 350000, '/images/airpodspro.jpg'),
('애플워치 9', '건강 모니터링 기능 강화', 650000, '/images/applewatch.png'),
('아이패드 프로', 'M2 칩 탑재 아이패드', 1400000, '/images/ipadpro.png'),
