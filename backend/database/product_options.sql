...
UPDATE products SET product_options = '[{"key":"color","label":"색상","values":["블랙","블루","핑크","옐로","그린"]},{"key":"storage","label":"용량","values":[{"value":"128GB","priceDelta":0},{"value":"256GB","priceDelta":200000},{"value":"512GB","priceDelta":400000}]}]'
WHERE name = '아이폰 15';

UPDATE products SET product_options = '[{"key":"color","label":"색상","values":["스페이스 그레이","실버"]},{"key":"storage","label":"저장공간","values":[{"value":"512GB","priceDelta":0},{"value":"1TB","priceDelta":400000}]}]'
WHERE name = '맥북 프로';
...
UPDATE products SET product_options = '[{"key":"size","label":"화면 크기","values":["11인치","12.9인치"]},{"key":"storage","label":"용량","values":[{"value":"256GB","priceDelta":0},{"value":"512GB","priceDelta":200000},{"value":"1TB","priceDelta":500000}]},{"key":"color","label":"색상","values":["스페이스 블랙","실버"]}]'
WHERE name = '아이패드 프로';
